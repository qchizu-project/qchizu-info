...
![](/images/elevation-tile-6.png)

0.01m位の標高データ使用

![](/images/elevation-tile-7.png)

0.1m位に四捨五入した標高データ使用

もう一つ例をお示しします。同じ栃木県の標高データを使った例ですが、こちらは傾斜のある山地です。谷底の緩傾斜の部分に等高線状のラインが一部で見られますが、それ以外の部分ではほとんど違いはありません。

![](/images/elevation-tile-8.png)

0.01m位の標高データ使用

![](/images/elevation-tile-9.png)
